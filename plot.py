...
fluxs = [int(3e9), int(3e8), int(3e7), int(3*(10**7.5)), int(3*(10**8.5))]#, int(3.002e9), int(3.003e9), int(3.004e9), int(3.005e9)]#[int(3e9), int(3*10**8.5), int(3e8), int(3*10**7.5), int(3e7)]
